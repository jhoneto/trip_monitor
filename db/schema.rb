...
ActiveRecord::Schema[8.0].define(version: 2025_09_23_235550) do
  ...
  create_table "user_route_resumes", force: :cascade do |t|
    t.bigint "user_id", null: false
    ...
    t.index ["kitetrip_route_id"], name: "index_user_route_resumes_on_kitetrip_route_id"
    t.index ["max_speed"], name: "index_user_route_resumes_on_max_speed"
    t.index ["total_distance"], name: "index_user_route_resumes_on_total_distance"
    t.index ["total_time"], name: "index_user_route_resumes_on_total_time"
    t.index ["user_id", "kitetrip_route_id"], name: "index_user_route_resumes_on_user_id_and_kitetrip_route_id"
    t.index ["user_id"], name: "index_user_route_resumes_on_user_id"
  end
  ...
  add_foreign_key "user_route_resumes", "kitetrip_routes"
  add_foreign_key "user_route_resumes", "users"
